# Probe POWER_RELIEF phase with a multi-Vt library so VT-swap and
# size-down candidate paths are both exercisable.  Strategy: first run
# the default timing-repair sequence (may upsize and/or VT-swap to
# higher-leakage cells to close timing), then run POWER_RELIEF as a
# follow-up phase to recover leakage on slack-positive instances.
source "helpers.tcl"
...
repair_timing -setup -phases "POWER_RELIEF"
report_worst_slack -max
report_design_area
